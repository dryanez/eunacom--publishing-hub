...
module.exports = {
  ...
  slides: [
...

    {
      ...
      stem: 'Hombre de 60 años consulta por baja de 8 kg de peso en 3 meses, epigastralgia sorda e hiporexia. No tiene ictericia.',
      question: '¿Cuál es el examen inicial más adecuado?',
      options: [
        { letter: 'A', text: 'TAC de abdomen y pelvis con contraste' },
        { letter: 'B', text: 'Endoscopía digestiva alta con biopsias' },
        { letter: 'C', text: 'Ecografía abdominal' },
        { letter: 'D', text: 'Marcadores tumorales (CEA, CA 19-9)' },
        { letter: 'E', text: 'Tránsito esofagogastroduodenal con bario' },
      ],
      correct: 'B',
      explanation: 'Baja de peso con epigastralgia en mayor de 40 años obliga a descartar cáncer gástrico: el examen que confirma es la endoscopía con biopsias. El TAC se usa después, para etapificar. Con ictericia, la sospecha sería cáncer de páncreas y ahí sí el examen inicial sería el TAC.',
      say: {
        stem: 'Ahora una pregunta del banco EUNACOM. Hombre de sesenta años que consulta por una baja de ocho kilos en tres meses, epigastralgia sorda e hiporexia. No tiene ictericia.',
        question: '¿Cuál es el examen inicial más adecuado?',
        options: 'Las opciones: TAC de abdomen y pelvis, endoscopía digestiva alta con biopsias, ecografía abdominal, marcadores tumorales, o un tránsito con bario. Piénsalo.',
        answer: 'La respuesta es la B, endoscopía con biopsias. Baja de peso con epigastralgia en un mayor de cuarenta es cáncer gástrico hasta demostrar lo contrario. El distractor es el TAC: sirve, pero después, para etapificar. Y fíjate en el detalle del enunciado, "no tiene ictericia". Está ahí justamente para que no pienses en páncreas.',
      },
    },

    {
      ...
      kicker: 'Pregunta real EUNACOM',
      title: 'Caso representativo · banco EUNACOM',
      stem: 'Mujer de 55 años con endoscopía por dispepsia: adenocarcinoma gástrico limitado a la mucosa, sin invasión de la submucosa, lesión de 15 mm bien diferenciada y sin úlcera. TAC sin adenopatías ni metástasis.',
      question: '¿Qué define el pronóstico y cuál es la conducta?',
      options: [
        { letter: 'A', text: 'El tamaño de la lesión; observación con endoscopías seriadas' },
        { letter: 'B', text: 'La profundidad de invasión de la pared; resección (endoscópica o quirúrgica) con intención curativa' },
        { letter: 'C', text: 'La presencia de H. pylori; solo terapia de erradicación' },
        { letter: 'D', text: 'El grado de diferenciación; quimioterapia paliativa' },
        { letter: 'E', text: 'El nivel de CEA; radioterapia externa' },
      ],
      correct: 'B',
      explanation: 'El factor pronóstico principal es la profundidad de invasión de la pared. Es un cáncer incipiente, el de mejor pronóstico; con estos criterios puede tratarse con resección endoscópica, y en otros casos con gastrectomía. Observar o solo erradicar deja el tumor sin tratar.',
      say: {
        stem: 'Otra del mismo banco. Mujer de cincuenta y cinco años, a la que la endoscopía por dispepsia le muestra un adenocarcinoma gástrico limitado a la mucosa, de quince milímetros, bien diferenciado y sin úlcera. El TAC no muestra adenopatías ni metástasis.',
        question: '¿Qué define el pronóstico y cuál es la conducta?',
        options: 'Las opciones: el tamaño y observar, la profundidad de invasión y resecar, el Helicobacter y erradicar, la diferenciación y quimioterapia paliativa, o el antígeno carcinoembrionario y radioterapia. Piénsalo.',
        answer: 'Es la B. Lo que define el pronóstico es la profundidad de invasión, y este tumor no pasa la mucosa: es incipiente, el de mejor pronóstico, y se reseca con intención curativa. Por ser pequeño, bien diferenciado y sin úlcera, puede ser por vía endoscópica. La trampa es la C: erradicar el Helicobacter está bien, pero solo, deja el cáncer sin tratar.',
      },
    },
