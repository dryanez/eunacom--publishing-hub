  ...
  pathway: {
    ...
    root: N('start', 'Paciente grave con sangrado multisitio', 'Séptico, obstétrico o politraumatizado',
      ...
      ['', N('q', '¿Score ISTH ≥ 5?', 'Plaquetas · dímero D · TP · fibrinógeno',
        ...
        ['SÍ', N('alert', 'CID manifiesta: tratar la causa', 'Foco séptico, útero, ATRA',
          'Cinco o más puntos: CID manifiesta. El pilar es tratar la causa de inmediato.',
          ['', N('q', '¿Sangra o requiere procedimiento?', 'Soporte transfusional',
            '¿El paciente sangra activamente o necesita un procedimiento invasivo?',
            ...
            ['SÍ', N('do', 'Crio + plasma + plaquetas', 'Fibrinógeno < 100–150 · TP/TTPK > 1,5 · plaquetas > 50.000',
