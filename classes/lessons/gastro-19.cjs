  ...
  slides: [
...

    {
      ...
      steps: [
        ...
        { show: ['aco'], note: 'Si tiene hambre, dudar',
          say: 'Se acompaña de anorexia, náuseas y febrícula. La anorexia es tan constante que un paciente con hambre te debe hacer dudar del diagnóstico.' },
...

    {
      ...
      cards: [
        { title: 'Diagnóstico', tag: 'Clínico', kind: 'criteria', items: [
          ...
          { t: 'Ecografía: niños y mujeres fértiles', d: 'Evita radiación y ve la pelvis',
...

    {
      ...
      steps: [
        ...
        { show: ['epi'], note: 'No se opera de entrada',
          say: 'Y aquí viene lo contraintuitivo: el plastrón no se opera de entrada. Primero se tratan con antibióticos, ceftriaxona más metronidazol, por varias semanas. El cuerpo ya contuvo el proceso, y operar ahí es meterse en un bloque inflamatorio.' },
      ...
      cards: [
        ...
        { title: 'Colonoscopía', tag: 'La trampa', kind: 'alert', items: [
          ...
          { t: 'A las 6–8 semanas', d: 'Para descartar cáncer',
            say: 'Se hace después, a las seis a ocho semanas, para descartar un cáncer de colon, que puede verse igual en el TAC. Como vimos en la clase de cáncer colorrectal, en un mayor de cincuenta ese diagnóstico no se puede dejar pasar.' },
        ] },
      ],
    },
...

    {
      ...
      stem: 'Mujer de 24 años consulta por dolor que comenzó alrededor del ombligo y en 12 horas se localizó en la fosa ilíaca derecha, con náuseas y falta de apetito. Al examen tiene Blumberg positivo en la fosa ilíaca derecha.',
      question: '¿Cuál es la primera conducta?',
      options: [
        { letter: 'A', text: 'Apendicectomía laparoscópica inmediata' },
        { letter: 'B', text: 'Test de embarazo y evaluación ginecológica' },
        { letter: 'C', text: 'TAC de abdomen y pelvis con contraste' },
        { letter: 'D', text: 'Iniciar antibióticos empíricos y observar 24 horas' },
        { letter: 'E', text: 'Colonoscopía urgente' },
      ],
      correct: 'B',
      explanation: 'En toda mujer en edad fértil con dolor en la FID y sospecha de apendicitis, lo primero es descartar patología ginecológica y sobre todo un embarazo ectópico: test de embarazo y evaluación ginecológica (con ecografía). Operar sin este paso puede pasar por alto un ectópico roto.',
      say: {
        stem: 'Ahora una pregunta del banco EUNACOM. Mujer de veinticuatro años con un dolor que empezó alrededor del ombligo y en doce horas se localizó en la fosa ilíaca derecha, con náuseas y falta de apetito. Al examen tiene Blumberg positivo en la fosa ilíaca derecha.',
        question: '¿Cuál es la primera conducta?',
        options: 'Las opciones: apendicectomía laparoscópica inmediata, test de embarazo y evaluación ginecológica, TAC de abdomen y pelvis, antibióticos y observar, o colonoscopía urgente. Piénsalo.',
        answer: 'La respuesta es la B. El cuadro es una apendicitis de libro, y justamente por eso es tentador marcar la apendicectomía inmediata. Pero la pregunta dice primera conducta, y la paciente es una mujer en edad fértil: primero test de embarazo y evaluación ginecológica. Recién después confirmas la apendicitis y la llevas a pabellón. La colonoscopía no tiene nada que hacer aquí.',
      },
    },

    {
      ...
      say: {
        stem: 'Otra pregunta del banco. Mujer de sesenta y tres años con diverticulitis aguda. El TAC muestra abundante líquido y aire libre en el peritoneo, con signos de peritonitis fecal difusa. Está febril, taquicárdica e hipotensa.',
        question: '¿Cuál es la conducta?',
      ...
      ['', N('do', 'Mujer fértil: test de embarazo', 'Y evaluación ginecológica',
        ...
        ['', N('q', '¿Dónde está el dolor?', 'Fosa ilíaca derecha o izquierda',
          ...
          ['Izquierda', N('do', 'TAC de abdomen y pelvis', 'Colonoscopía contraindicada en agudo',
            'Dolor en fosa ilíaca izquierda con fiebre en un mayor de cincuenta: diverticulitis. TAC de abdomen y pelvis con contraste; la colonoscopía se hace a las seis a ocho semanas, nunca en el episodio agudo.',
            ['', N('q', 'Hinchey: ¿absceso o peritonitis?', 'Según el TAC',
              '¿El TAC muestra un absceso o una peritonitis?',
