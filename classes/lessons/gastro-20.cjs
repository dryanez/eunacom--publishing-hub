...
module.exports = {
  ...
  slides: [
...

    {
      ...
      stem: 'Paciente de 72 años con fibrilación auricular presenta dolor abdominal súbito y muy intenso. El examen abdominal es prácticamente normal, sin defensa ni Blumberg.',
      question: '¿Cuál es el examen diagnóstico de elección?',
      options: [
        { letter: 'A', text: 'TAC de abdomen sin contraste' },
        { letter: 'B', text: 'Ecografía abdominal' },
        { letter: 'C', text: 'Angio-TAC (o angiografía) mesentérica' },
        { letter: 'D', text: 'Radiografía de abdomen simple' },
        { letter: 'E', text: 'Colonoscopía urgente' },
      ],
      correct: 'C',
      explanation: 'FA + dolor súbito intenso + disociación clínica: embolia mesentérica. El angio-TAC muestra el defecto de llene en la arteria mesentérica superior; la angiografía formal se usa si además se planea tratamiento endovascular. El TAC sin contraste y la radiografía no muestran el émbolo y hacen perder tiempo.',
      say: {
        stem: 'Ahora una pregunta del banco EUNACOM. Paciente de setenta y dos años con fibrilación auricular, que presenta un dolor abdominal súbito y muy intenso. El examen abdominal es prácticamente normal, sin defensa ni Blumberg.',
        question: '¿Cuál es el examen diagnóstico de elección?',
        options: 'Las opciones: TAC sin contraste, ecografía abdominal, angio-TAC o angiografía mesentérica, radiografía simple, o colonoscopía urgente. Piénsalo.',
        answer: 'La respuesta es la C. Ya reconoces la frase: fibrilación auricular, dolor súbito, abdomen casi normal. Es una embolia, y para ver un émbolo necesitas contraste dentro de la arteria: angio-TAC, o angiografía si además se va a tratar por vía endovascular. El distractor más tentador es el TAC sin contraste, porque suena a examen completo, pero sin contraste la arteria no se ve, y pierdes un tiempo que el intestino no tiene.',
      },
    },

    {
      ...
      say: {
        stem: 'Y otra pregunta del banco. Hombre de setenta años con ateroesclerosis que, después de un episodio de hipotensión por una hemorragia digestiva, presenta dolor cólico en el flanco izquierdo y elimina deposiciones con sangre roja. El abdomen está sensible en el flanco izquierdo, sin peritonismo.',
        question: '¿Cuál es el diagnóstico más probable?',
