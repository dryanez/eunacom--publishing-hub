...
module.exports = {
  ...
  slides: [
...

    {
      ...
      steps: [
        { show: ['com'], note: 'El cuerpo extraño más común en adultos',
        ...
        { show: ['obs'], note: 'Muchos pasan solos',
          say: 'Si tolera líquidos y no tiene dolor, se puede observar hasta veinticuatro horas.' },
        ...
        { show: ['est'], note: 'Un esófago sano rara vez atrapa comida',
          say: 'Y después del episodio, se estudia el esófago. Una impactación puede ser la primera señal de una esofagitis eosinofílica, una estenosis o un anillo, como vimos en la clase de disfagia.' },
      ],
    },
      ...
      cards: [
        ...
        { title: 'No hacer', tag: 'Trampa', kind: 'criteria', items: [
          { t: 'Nada de maniobra de Heimlich', d: 'Solo en obstrucción de la vía aérea',
            say: 'Y una trampa que aparece en las alternativas: la maniobra de Heimlich. No se hace por un cuerpo extraño digestivo; se usa solo en la obstrucción completa de la vía aérea. Si el niño respira y habla, el objeto está en el tubo digestivo, no en la tráquea.' },
          { t: 'Nada de laxantes para apurarlo', d: 'Se observa, no se empuja',
            say: 'Tampoco se trata de acelerar el tránsito. El objeto romo se observa con radiografías; no se empuja.' },
        ] },
      ],
    },
...

    {
      ...
      stem: 'Hombre de 45 años con sensación de cuerpo extraño retroesternal tras comer un trozo grande de carne hace 6 horas. Tiene dolor retroesternal y no consigue tragar ni siquiera su saliva.',
      question: '¿Cuál es la conducta?',
      options: [
        { letter: 'A', text: 'Observación por 24 horas' },
        { letter: 'B', text: 'Radiografía de tórax y control en 12 horas' },
        { letter: 'C', text: 'Endoscopía digestiva alta para desimpactar' },
        { letter: 'D', text: 'Bebida carbonatada y enzimas proteolíticas' },
        { letter: 'E', text: 'TAC de tórax con contraste' },
      ],
      correct: 'C',
      explanation: 'Comida impactada con dolor e incapacidad de tragar la saliva (obstrucción completa): endoscopía para retirarla, sin demora, por riesgo de aspiración y perforación. Solo se observa hasta 24 h si no hay dolor y tolera líquidos. Después, estudiar el esófago.',
      say: {
        stem: 'Ahora una pregunta del banco EUNACOM. Hombre de cuarenta y cinco años con sensación de cuerpo extraño detrás del esternón, después de comer un trozo grande de carne hace seis horas. Tiene dolor retroesternal y no logra tragar ni siquiera su saliva.',
        question: '¿Cuál es la conducta?',
        options: 'Las opciones: observar veinticuatro horas, radiografía y control en doce horas, endoscopía para desimpactar, bebida carbonatada con enzimas, o TAC de tórax. Piénsalo.',
        answer: 'La respuesta es la C. No traga su saliva y tiene dolor: es una obstrucción completa, y eso exige endoscopía sin demora, por el riesgo de aspiración y de perforación. La trampa es la A: observar veinticuatro horas solo vale cuando el paciente tolera líquidos y no tiene dolor, y este no cumple ninguna de las dos.',
      },
    },

    {
      ...
      kicker: 'Pregunta real EUNACOM',
      title: 'Caso representativo · banco EUNACOM',
      stem: 'Niño de 5 años se tragó una moneda hace 3 horas. Está asintomático, sin sialorrea ni dificultad para tragar. La radiografía muestra la moneda en la cámara gástrica.',
      question: '¿Cuál es la conducta más apropiada?',
      options: [
        { letter: 'A', text: 'Endoscopía digestiva alta urgente' },
        { letter: 'B', text: 'Laparotomía para extraer la moneda' },
        { letter: 'C', text: 'Observación con control radiológico cada 1–2 semanas' },
        { letter: 'D', text: 'Administrar un laxante para acelerar el tránsito' },
        { letter: 'E', text: 'Maniobra de Heimlich' },
      ],
      correct: 'C',
      explanation: 'Moneda (roma, no cáustica, no magnética) que ya pasó el esófago, en un niño asintomático: observación con radiografía cada 1–2 semanas; la gran mayoría se elimina sola. Endoscopía solo si no progresa en 3–4 semanas o aparecen síntomas.',
      say: {
        stem: 'Una más del banco. Niño de cinco años que se tragó una moneda hace tres horas. Está asintomático, sin sialorrea ni dificultad para tragar, y la radiografía muestra la moneda en el estómago.',
        question: '¿Cuál es la conducta más apropiada?',
        options: 'Las opciones: endoscopía urgente, laparotomía, observación con radiografía cada una a dos semanas, un laxante, o la maniobra de Heimlich. Piénsalo.',
        answer: 'Es la C. Aplica las dos preguntas: ya pasó el esófago, y es un objeto romo que no está en la lista. Se observa con radiografías, y la gran mayoría se elimina sola. La endoscopía urgente sería la respuesta si fuera una pila o dos imanes; y el Heimlich y el laxante son las trampas que ya conoces.',
      },
    },
