...
module.exports = {
  ...
  slides: [
...

    {
      ...
      stem: 'Recién nacido de 4 semanas, previamente sano, con 5 días de vómitos explosivos posprandiales. Se muestra ávido por alimentarse. Al examen tiene signos de deshidratación; en el laboratorio destaca hipopotasemia y alcalosis metabólica.',
      question: '¿Cuál es el examen diagnóstico más apropiado?',
      options: [
        { letter: 'A', text: 'pH-metría esofágica de 24 horas' },
        { letter: 'B', text: 'Radiografía de abdomen simple' },
        { letter: 'C', text: 'Ecografía abdominal' },
        { letter: 'D', text: 'Endoscopía digestiva alta' },
        { letter: 'E', text: 'TAC de abdomen' },
      ],
      correct: 'C',
      explanation: 'Vómitos explosivos entre la 2.ª y 6.ª semana, lactante hambriento, deshidratación y alcalosis hipoclorémica e hipopotasémica (pérdida de HCl): estenosis hipertrófica del píloro. Se confirma con ecografía abdominal (músculo pilórico engrosado). Tratamiento: corrección hidroelectrolítica y pilorotomía de Ramstedt.',
      say: {
        stem: 'Ahora una pregunta del banco EUNACOM. Recién nacido de cuatro semanas, previamente sano, con cinco días de vómitos explosivos después de comer. Está ávido por alimentarse. Al examen tiene signos de deshidratación, y en el laboratorio destaca hipopotasemia y alcalosis metabólica.',
        question: '¿Cuál es el examen diagnóstico más apropiado?',
        options: 'Las opciones: pH-metría de veinticuatro horas, radiografía de abdomen simple, ecografía abdominal, endoscopía alta, o TAC de abdomen. Piénsalo.',
        answer: 'Es la C, ecografía abdominal. El enunciado te da todas las piezas: cuatro semanas de vida, vómitos explosivos, un lactante hambriento, y alcalosis con hipopotasemia por la pérdida de ácido. Es una estenosis del píloro, y la ecografía muestra el músculo engrosado. La pH-metría tienta porque el lactante vomita y piensas en reflujo, pero un reflujo no deshidrata ni da alcalosis.',
      },
    },

    {
      ...
      kicker: 'Pregunta real EUNACOM',
      title: 'Banco EUNACOM · Caso representativo',
      stem: 'Niño de 5 años con constipación crónica presenta dolor abdominal y manchado fecal en la ropa interior. Al examen se palpa una masa en el hipogastrio y, al tacto rectal, una gran masa fecal dura en la ampolla rectal.',
      question: '¿Cuál es el tratamiento inicial?',
      options: [
        { letter: 'A', text: 'Dieta rica en fibra y aumento de la ingesta de agua' },
        { letter: 'B', text: 'Polietilenglicol por vía oral para desimpactar' },
        { letter: 'C', text: 'Extracción digital del fecaloma bajo sedación' },
        { letter: 'D', text: 'Laxantes osmóticos en dosis de mantenimiento de forma indefinida' },
        { letter: 'E', text: 'Derivación quirúrgica' },
      ],
      correct: 'B',
      explanation: 'Antes de cualquier medida de mantenimiento hay que desimpactar, y el tratamiento de elección es el polietilenglicol oral (alternativa: enema). El manchado es pseudoincontinencia por rebosamiento. Dieta y laxantes de mantenimiento se inician una vez vaciado el recto; la extracción digital es excepcional.',
      say: {
        stem: 'Y otra pregunta del banco. Niño de cinco años con constipación crónica, que presenta dolor abdominal y manchado fecal en la ropa interior. Al examen se palpa una masa en el hipogastrio, y al tacto rectal, una gran masa fecal dura en la ampolla.',
        question: '¿Cuál es el tratamiento inicial?',
        options: 'Las opciones: dieta rica en fibra y agua, polietilenglicol oral para desimpactar, extracción digital bajo sedación, laxantes de mantención indefinidos, o derivación quirúrgica. Piénsalo.',
        answer: 'Es la B. Hay un fecaloma, y el manchado es rebosamiento, no diarrea. Lo primero es desimpactar, y el tratamiento de elección es el polietilenglicol oral. La fibra y el agua tientan porque son correctas, pero son de la segunda fase: si partes por ahí, el fecaloma no sale. Y la extracción digital se reserva para casos excepcionales.',
      },
    },
