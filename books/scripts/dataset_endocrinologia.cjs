/**
 * Tomo 07: Endocrinología & Metabolismo
 ...
 * Cabecera del Solucionario: Violeta (#7c3aed)
 */

const b1 = require('./dataset_endocrinologia_bloque_1.cjs');
const b2 = require('./dataset_endocrinologia_bloque_2.cjs');
const b3 = require('./dataset_endocrinologia_bloque_3.cjs');
const b4 = require('./dataset_endocrinologia_bloque_4.cjs');
const b5 = require('./dataset_endocrinologia_bloque_5.cjs');
...
const endocrinologiaClasses = rawClasses.map(c => {
